...
class TripMetrics(BaseModel):
    ...
    fuel_saved_liters = Column(Numeric(6, 3), default=0)
    co2_avoided_kg = Column(Numeric(6, 3), default=0)
    pollution_exposure_avoided = Column(Numeric(6, 3), default=0)  # PM2.5 units
